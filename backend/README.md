...
## Project Structure
    ...
    ├── testlibraryedit_dev_29325  # Django project configurations
...
1. Clone this repo and `cd testlibraryedit_dev_29325`
...
2. Clone this repo and `cd testlibraryedit_dev_29325`
